...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* =========================================================
     ...
     ---------------------------------------------------------
     ÖSYM'nin açıkladığı 2026-KPSS Ortaöğretim (Lise mezunları)
     Genel Yetenek-Genel Kültür oturumu 25 Ekim 2026 Pazar günü,
     saat 10:00'dan sonra sınav binalarına giriş yapılamayacaktır.
     Farklı bir sınav dönemi için bu tarihi güncellemeniz yeterli.
     ========================================================= */
  const SINAV_TARIHI = new Date('2026-10-25T10:00:00');
  ...
  function sayaciGuncelle() {
    ...
    elNot.textContent = 'KPSS Ortaöğretim (Genel Yetenek-Genel Kültür) — 25 Ekim 2026';
  }
